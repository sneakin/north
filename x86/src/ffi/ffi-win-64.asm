...
defop ffi_win_64_rax_1_0
	...
	jmp [d_ffi_win_64_rax_0_0+dict_entry_code]
...
defop ffi_win_64_rax_n_0
  pop r13
  pop r14
  call [d_ffi_win_64_rax_any_0+dict_entry_code]
  push r14
  push r13
  ret
...
defop ffi_win_64_rax_1_1
	mov rcx, [rsp+ptrsize*1]
	jmp [d_ffi_win_64_rax_0_1+dict_entry_code]
...
defop ffi_win_64_%+ num_args %+ _%+ num_returns
  ...
  push rbx
%if num_args >= 4
  jmp [d_ffi_win_64_rax_4_%+ num_returns %+ +dict_entry_code]
%else
  jmp [d_ffi_win_64_rax_%+ num_args %+_%+ num_returns +dict_entry_code]
%endif
...
defop ffi_win_64_op_n_0
  mov rax, [rax+dict_entry_data]
  jmp [d_ffi_win_64_rax_n_0+dict_entry_code]
...
defop ffi_win_64_op_n_1
  mov rax, [rax+dict_entry_data]
  jmp [d_ffi_win_64_rax_n_1+dict_entry_code]
